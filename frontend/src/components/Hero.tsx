    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-20">
        ...
        <h1 className="font-serif font-bold text-forest-900 text-5xl sm:text-6xl md:text-7xl leading-tight mb-6">
          Your Yard,{' '}
          <span className="text-forest-600 italic">Transformed.</span>
        </h1>

        {/* Subheadline */}
        <p className="font-sans text-forest-800 text-lg sm:text-xl md:text-2xl font-bold leading-relaxed max-w-2xl mx-auto mb-10">

...
const Leaf = createLucideIcon("leaf", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Ruler = createLucideIcon("ruler", __iconNode$3);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function MapGridIcon({ className }) {
...
const highlights = [
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapGridIcon, { className: "w-5 h-5" }),
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -left-4 w-full h-full bg-forest-100 rounded-lg -z-10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 -right-4 w-32 h-32 bg-soil-200 rounded-lg -z-10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-lg overflow-hidden shadow-earthy-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Owner of Green Root Lawn Care"
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-6 -right-2 sm:-right-6 bg-soil-400 text-forest-900 rounded-lg px-5 py-4 shadow-earthy-lg text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-bold text-3xl leading-none", children: "5+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-xs font-medium mt-1 leading-tight", children: [
          "Years of",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:pl-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-forest-600 font-sans text-sm font-semibold tracking-widest uppercase mb-3", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif font-bold text-forest-800 text-4xl sm:text-5xl mb-4 leading-tight", children: [
        "A Passion for the",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest-500 italic", children: "Outdoors" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-soil-400 mb-6 rounded-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-foreground/80 text-base leading-relaxed mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Hi, I'm Matthew, the sole owner of Green Root Lawn Care. I started this business with a simple belief: every yard deserves to look its best, and every client deserves honest, dependable service." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I handle every job personally, which means you'll always know who's showing up at your door. No subcontractors, no surprises. Just me, my tools, and a genuine commitment to making your outdoor space something you're proud of." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: highlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-center gap-3 bg-forest-50 border border-forest-100 rounded-lg px-4 py-3",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest-600 shrink-0", children: item.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-forest-800 text-sm font-medium", children: item.text })
          ]
        },
        item.text
      )) })
...
function usePhoneHoursStatus() {
  ...
  reactExports.useEffect(() => {
    const interval = setInterval(() => setStatus(getStatus()), 6e4);
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 bg-cream-200 texture-bg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-forest-600 font-sans text-sm font-semibold tracking-widest uppercase mb-3", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif font-bold text-forest-900 text-4xl sm:text-5xl mb-4 leading-tight", children: [
        "Ready for a",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest-600 italic", children: "Beautiful Yard?" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-soil-400 mb-6 rounded-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-800 text-lg leading-relaxed mb-10", children: "Reach out today for a free, no-obligation quote. I'll come take a look at your property and put together a plan that fits your needs and budget." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-cream-100 border border-forest-200 rounded-lg p-5 hover:bg-cream-50 transition-colors shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-lg bg-forest-100 text-forest-600 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-500 text-xs font-semibold tracking-widest uppercase mb-0.5", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-900 text-sm font-medium leading-snug", children: "940-735-8008" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `inline-flex items-center text-xs font-semibold px-2 py-0.5 rounded-full ${phoneStatus === "open" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-600"}`,
                  children: [
                    "Phone hours: ",
                    phoneStatus
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-600 text-xs mt-0.5", children: "call during phone hours, text anytime." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: `font-sans text-xs mt-1 ${phoneStatus === "open" ? "text-green-700" : "text-red-600"}`,
                children: "I work an evening job from 4pm to 10pm and am unable to accept phone calls during that time."
              }
            )
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-cream-100 border border-forest-200 rounded-lg p-5 hover:bg-cream-50 transition-colors shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-lg bg-forest-100 text-forest-600 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-500 text-xs font-semibold tracking-widest uppercase mb-0.5", children: "Service Area" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-900 text-sm font-medium leading-snug", children: "Marshall, Jefferson & Surrounding Areas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-600 text-xs mt-0.5", children: "East Texas, TX" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-cream-100 border border-forest-200 rounded-lg p-5 hover:bg-cream-50 transition-colors shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-lg bg-forest-100 text-forest-600 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-500 text-xs font-semibold tracking-widest uppercase mb-0.5", children: "Hours" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-900 text-sm font-medium leading-snug", children: "Every Day: 7:00 AM – 3:00 PM" })
          ] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-cream-100 rounded-lg p-8 sm:p-10 shadow-earthy-lg border border-forest-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-forest-800 text-2xl mb-2", children: "Request a Free Quote" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-muted-foreground text-sm mb-6", children: [
        "Fill out the form below and I'll get back to you. Fields marked with ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500 font-semibold", children: "*" }),
        " ",
        "are required."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "space-y-4", onSubmit: (e) => e.preventDefault(), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
              {
                ...
                children: [
                  "Last Name",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest-500 font-normal text-xs", children: "(optional)" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-500 text-xs mb-1.5", children: "Providing your address helps me give you a more accurate quote." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "quote-address",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-muted-foreground text-xs text-center", children: "No spam, ever. I'll only use your info to respond to your request." })
      ] })
    ] })
  ] }) }) });
}
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-cream-100 text-forest-700 border-t border-forest-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-forest-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-5 h-5 text-cream-50" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-serif font-bold text-forest-900 text-lg leading-tight", children: "Green Root" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-forest-600 text-xs tracking-widest uppercase leading-tight", children: "Lawn Care" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-700 text-sm leading-relaxed max-w-xs", children: "Professional, personal lawn care services for homeowners who take pride in their outdoor spaces." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif font-semibold text-forest-900 text-base mb-4", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: navLinks$1.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif font-semibold text-forest-900 text-base mb-4", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3 font-sans text-forest-700 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-forest-600 shrink-0" }),
            "940-735-8008"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 font-sans text-forest-700 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-forest-600 shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Marshall, Jefferson & Surrounding Areas",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest-600", children: "East Texas, TX" })
            ] })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-forest-200 py-6 flex items-center justify-center text-xs font-sans text-forest-600", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "© ",
      year,
      " Green Root Lawn Care. All rights reserved."
    ] }) })
  ] }) });
}
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black/40 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/15 border border-white/40 text-white text-sm font-sans font-medium mb-8 tracking-wide", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif font-bold text-white text-5xl sm:text-6xl md:text-7xl leading-tight mb-6 drop-shadow-lg", children: [
            "Your Yard, ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300 italic", children: "Transformed." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-white text-lg sm:text-xl md:text-2xl font-semibold leading-relaxed max-w-2xl mx-auto mb-10 drop-shadow", children: "Professional lawn care services with a personal touch. I take pride in every blade of grass." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 flex flex-wrap justify-center gap-8 text-white font-sans text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300 font-bold text-2xl font-serif", children: "5+" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Years Experience" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-white/30 hidden sm:block" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300 font-bold text-2xl font-serif", children: "Dozens" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "of Satisfied Customers" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-white/30 hidden sm:block" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300 font-bold text-2xl font-serif", children: "100%" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Satisfaction Guaranteed" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "w-6 h-6" })
          }
        )
      ]
    }
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-cream-100 shadow-earthy-lg" : "bg-cream-50/95 backdrop-blur-sm"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-forest-600 flex items-center justify-center group-hover:bg-forest-500 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-5 h-5 text-cream-50" }) }),
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-cream-50 border-t border-forest-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "px-4 py-4 flex flex-col gap-1", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function PushMowerIcon({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      role: "img",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "28", cy: "55", r: "2", fill: "currentColor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "12",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "55", r: "2", fill: "currentColor" })
      ]
    }
  );
}
const services = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PushMowerIcon, { className: "w-7 h-7" }),
    title: "Lawn Mowing",
    description: "Clean, even cuts every visit to keep your lawn healthy, tidy, and looking its best throughout the season."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wheat, { className: "w-7 h-7" }),
    title: "Weed Eating",
    description: "Precise string trimming around fences, trees, flower beds, and hard-to-reach spots a mower can't get to."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Ruler, { className: "w-7 h-7" }),
    title: "Edging",
    description: "Sharp, defined edges along driveways, sidewalks, and curbs for that crisp, professional finished look."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-7 h-7" }),
    title: "Blow Off / Air Clean",
    description: "After every job I blow away all the clippings and mess with a leaf blower, leaving your property spotless and clean."
  }
];
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-24 bg-cream-200 texture-bg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-forest-600 font-sans text-sm font-semibold tracking-widest uppercase mb-3", children: "What I Offer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif font-bold text-forest-800 text-4xl sm:text-5xl mb-4", children: "Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-soil-400 mx-auto mb-6 rounded-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed", children: "Simple, reliable lawn care done right. I focus on the essentials so your yard always looks sharp." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8", children: services.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-lg bg-forest-100 text-forest-600 flex items-center justify-center mb-5 mx-auto group-hover:bg-forest-600 group-hover:text-cream-100 transition-colors duration-300 border-0", children: service.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-semibold text-forest-800 text-xl mb-3 leading-snug", children: service.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-muted-foreground text-sm leading-relaxed", children: service.description })
        ]
      },
      service.title
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 bg-cream-100 border border-forest-200 rounded-lg p-8 sm:p-10 text-center shadow-earthy-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-forest-900 text-2xl sm:text-3xl mb-3", children: "Ready for a cleaner yard?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-forest-700 text-base mb-6 max-w-lg mx-auto", children: "I'll come out and take a look at your property for free. No pressure, no obligation." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: "Schedule a Free Assessment"
        }
      )
    ] })
  ] }) });

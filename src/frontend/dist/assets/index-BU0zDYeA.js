        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-cream-100 border border-forest-200 rounded-lg p-5 hover:bg-cream-50 transition-colors shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: `font-sans text-xs mt-1.5 leading-snug italic ${phoneStatus === "open" ? "text-green-700" : "text-red-600"}`,
                children: "I work an evening job from 4pm to 10pm and I am unable to answer the phone around that time. Text is the best way to reach me during that time."
              }
            )
          ] })
        ] }) }),
